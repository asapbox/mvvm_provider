...
class PlayerWidget extends StatefulWidget {
  ...
  @override
  State<PlayerWidget> createState() => _PlayerWidgetState(mode);
}
...
class _PlayerWidgetState extends State<PlayerWidget> {
  ...
  get _isPlaying => PlayerState == PlayerState.playing;
  ...
  void _initAudioPlayer() {
    ...
    _durationSubscription = _audioPlayer.onDurationChanged.listen(
      (duration) {
        ...
        /// there are no methods such as startHeadlessService()
        /// and setNotification() in the current version of
        /// the audioplayers package
